...
#define IOCTL_ENABLE_DSE_HVM               CTL_CODE(FILE_DEVICE_UNKNOWN, 0x436, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_DISABLE_DSE_HVM              CTL_CODE(FILE_DEVICE_UNKNOWN, 0x437, METHOD_BUFFERED, FILE_ANY_ACCESS)
...
#define IOCTL_READ_MEMORY_CHECK            CTL_CODE(FILE_DEVICE_UNKNOWN, 0x605, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_WRITE_MEMORY                 CTL_CODE(FILE_DEVICE_UNKNOWN, 0x606, METHOD_BUFFERED, FILE_ANY_ACCESS)
...
#define IOCTL_IRP_RENAME_FILE              CTL_CODE(FILE_DEVICE_UNKNOWN, 0x950, METHOD_BUFFERED, FILE_ANY_ACCESS)
